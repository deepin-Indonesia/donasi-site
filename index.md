    ...
    <div class="donasi-card">
      <div class="donasi-card__info">
        ...
        <div class="donasi-notes">
          <p><i class="fas fa-info-circle"></i> <strong>Nama</strong> dan <strong>email</strong> bersifat opsional — jika diisi akan ditampilkan di halaman ini sebagai daftar donatur publik. Email sudah disensor di dalam CSV (contoh: <code>budi********</code>) sebelum dipublikasikan.</p>
          ...
          <p><i class="fas fa-lock"></i> Repository ini <strong>private</strong> — data CSV hanya diakses oleh pengelola.</p>
        </div>
      </div>
